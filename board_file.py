...
class Board:
    ...
    def __init__(self, x_cells, y_cells, cell_size, top_indent, left_indent, player_data, character):
        ...
        self.forest_top = load_image("forest_top.png")
        self.forest_left = load_image("forest_left.png")
        self.forest_bottom = load_image("forest_bottom.png")
        self.forest_right = load_image("forest_right.png")
        self.forest_topright = load_image("forest_topright.png")
        self.forest_topleft = load_image("forest_topleft.png")
        self.forest_bottomleft = load_image("forest_bottomleft.png")
        self.forest_bottomright = load_image("forest_bottomright.png")
    ...
    def game_render(self, screen):
        ...
        for y in range(self.height_in_cells):
            for x in range(self.width_in_cells):
                if self.room_for_render[y][x] == '1' and x == (self.width_in_cells - 1) and y == 0:
                    screen.blit(self.forest_topright, (x * self.cs + self.left, y * self.cs + self.top))
                if (self.room_for_render[y][x] == '1' and x == (self.width_in_cells - 1) and y != 0
                        and y != (self.height_in_cells - 1)):
                    screen.blit(self.forest_right, (x * self.cs + self.left, y * self.cs + self.top))
                if (self.room_for_render[y][x] == '1' and x == (self.width_in_cells - 1) and y != 0
                        and y == (self.height_in_cells - 1)):
                    screen.blit(self.forest_bottomright, (x * self.cs + self.left, y * self.cs + self.top))

                if self.room_for_render[y][x] == '1' and x == 0 and y == 0:
                    screen.blit(self.forest_topleft, (x * self.cs + self.left, y * self.cs + self.top))
                if self.room_for_render[y][x] == '1' and x == 0 and y != 0 and y != (self.height_in_cells - 1):
                    screen.blit(self.forest_left, (x * self.cs + self.left, y * self.cs + self.top))
                if self.room_for_render[y][x] == '1' and x == 0 and y != 0 and y == (self.height_in_cells - 1):
                    screen.blit(self.forest_bottomleft, (x * self.cs + self.left, y * self.cs + self.top))

                if (self.room_for_render[y][x] == '1' and x != 0 and x != (self.width_in_cells - 1)
                        and y == 0 and y != (self.height_in_cells - 1)):
                    screen.blit(self.forest_top, (x * self.cs + self.left, y * self.cs + self.top))
                if (self.room_for_render[y][x] == '1' and x != 0 and x != (self.width_in_cells - 1) and
                        y != 0 and y == (self.height_in_cells - 1)):
                    screen.blit(self.forest_bottom, (x * self.cs + self.left, y * self.cs + self.top))
